...
<script>
function PWD_CHECK(){
    if(document.form2.pwd.value!=document.form2.pwd_re.value){
        alert("Please check your password again");
        document.form2.pwd_re.value="";
...
<form name="form2" action="join_final2.jsp" method="POST">
<table>
	<tr>
	<td>ID</td>
	...
	<td colspan="3"><textarea name="intro" maxLength="300"cols="50" rows="10"></textarea></td>
	</tr>
	<tr><td>&nbsp;</td></tr>
</table>
