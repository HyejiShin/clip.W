...
<title>w.clip_NOTICE_write</title>
<style>
	.m_notice {
...
<body>
   ...
   String curuser = (String)session.getAttribute("user");
	...
	<h3 style="text-align: center"><div class="page_title"><br>NOTICE_POST</br></div></h3>
	
	<form enctype="multipart/form-data" name="notice_write_form" action="notice_ok.jsp" onSubmit="return form_check()">
		<table align="center">
