...
<%	
	...
	try{
		...
		pstmt.setString(4, formGender);
		pstmt.setString(5, formBirth);
		pstmt.setString(6, formCel);
		pstmt.setString(7, formPos);
		pstmt.setString(8,"");
		pstmt.setString(9, formIntro);
		pstmt.setString(10, "images/me.jpg");
		pstmt.executeUpdate();
		%>
